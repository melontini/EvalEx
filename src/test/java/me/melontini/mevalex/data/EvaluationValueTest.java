...
import static me.melontini.mevalex.config.ExpressionConfiguration.defaultConfiguration;
import static me.melontini.mevalex.config.ExpressionConfiguration.defaultExpressionParser;
...
class EvaluationValueTest {
  ...
  void testBooleanValueSameInstances() {
    Assertions.assertThat(BooleanValue.of(Boolean.TRUE)).isSameAs(BooleanValue.TRUE);
  ...
  void testExpressionNode() {
    ASTNode node = ASTNode.of(new Token(1, "a", Token.TokenType.VARIABLE_OR_CONSTANT));
    EvaluationValue value =
